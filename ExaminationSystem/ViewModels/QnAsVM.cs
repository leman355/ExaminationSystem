...
namespace ExaminationSystem.ViewModels
{
    public class QnAsVM
    {
        ...
        public List<QnAsVM> QnAsList { get; set; }
        public List<Exams> ExamList { get; set; }
        public int TotalCount { get; set; }
        public int SelectedAnswer { get; set; }
        public QnAsVM(QnAs model)
        {
            Id = model.Id;
            ExamsId = model.ExamsId.ToString();
        ...
        public QnAs ConvertViewModel(QnAsVM vm)
        {
            return new QnAs
            {
                Id = vm.Id,
                ExamsId = Guid.Parse(vm.ExamsId),
                Option1 = vm.Option1 ?? "",
                Option2 = vm.Option2 ?? "",
                Option3 = vm.Option3 ?? "",
                Option4 = vm.Option4 ?? "",
